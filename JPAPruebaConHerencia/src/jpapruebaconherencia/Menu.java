...
public class Menu {
    ...
    // y 3 objetos Mascota. Almacena los objetos Mascotas en dos listas
    ...
    public void ejecucion() {
        ...
        try {
            ...
            Logger.getLogger(JPAPruebaConHerencia.class.getName()).log(Level.SEVERE, null, ex);
        }
